...
HD_PWD='Z:/Sync/autosync/DAC_v0/DAC_v0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topWrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topWrapper.tcl -notrace
