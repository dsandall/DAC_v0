...
HD_PWD='Z:/Sync/autosync/DAC_v0/DAC_v0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topWrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topWrapper.tcl
